...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Dwarkesh Bakers | Cookie Store</title><meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1, maximum-scale=1, minimum-scale=1" />
...
<!--/*****************************------------------  Fonts  ------------------*****************************/-->
    ...
    <body>
        ...
        <?php include './Navbar.php'; $res = mysqli_query($con, "select * from product_details where cat_id=20");
        ?>
        <?php include './js/common.php'?>
        
        <div class="parallax-container">
            <div class="parallax"><img class="heading-img-effect" src="Images/Image14.jpg" width="100%"></div>
            <div class="Page-Heading-parallax">
                <div class="opacity-section">
                    <center>
                        <span class="page-heading">Cookie Store</span>
...
<script>function sort1(str) {
    ...
    <script>function sort(str) {
            window.location = "Cookie_Store.php?chk1=" + str;
        }</script>
     <script>
