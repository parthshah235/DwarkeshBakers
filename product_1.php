                ...
                <div class="row">
                    ...
                    <div class="col s12 m5 l5 offset-l1 offset-m1 pull-l1 pull-m1" style="padding-right: 100px">
                            <div class="row">
                                ...
                                <div class="col s3 m2 l2" id="row-margin">
                                    <input id="qty<?php echo $row["prd_id"] ?>" type="number" class="disabled validate" disabled="disabled" value="1" style="color: #000">  <label for="qty" class="red-text"></label>
                                </div>
                                <div class="col s2 m2 l2" id="row-margin">
                                    <span class="quantity-unit">/ 
                                        <?php 
                                            if($row['cat_id']==17 || $row['cat_id']==20 || $row['cat_id']==21)
                                            {
                                                echo "pc";
                                            }
                                            else
