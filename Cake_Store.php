...
<html>
    ...
    <body>
        ...
        <?php
        include './Navbar.php';
        $res = mysqli_query($con, "select * from product_details where cat_id=16 $sort1 $sort");
        ?>
        ...
        <h5 align="center" color="red">*Note: Price are of 1Kg</h5>
                ...
                <?php while ($row = mysqli_fetch_array($res)) { ?> 
                    <div class="col s12 m6 l4">
                        <div class="card">
                            ...
                            <div class="col s3 m2 l2" id="row-margin">
                                <input id="qty<?php echo $row["prd_id"] ?>" hidden="" type="number" class="disabled validate"  value="0.5" style="color: #000">  <label for="qty" class="red-text"></label>
                            </div>
                            <!--                            <div class="col s2 m2 l2" id="row-margin">
                                                            <span class="quantity-unit">/ kg</span>
                                                        </div>-->
                            <div class="col s4 m3 l3" id="row-margin">
                                <button class="quantiy-button" hidden="" onclick="qtyupdp(<?php echo $row["prd_id"]; ?>)" value="0.5"><i class="fa fa-plus" aria-hidden="true"></i></button>
                            </div>

                            <?php if (($row['prd_quantity'] == 0) || ($row['prd_quantity']<0)){ ?>
                                <div class="col s2 m2 l2 red-text" style="margin-top: 9px;width:200px;">
                                    <center><h5>Out Of Stock</h5></center>
                                </div>
                                <center>
    ...
    <!--                                <center>
                                    <span style="color: #515151"> 
                                        <button class="product-fotter-button-css" value='<?php echo $row["prd_name"] ?>' id='<?php echo $row["prd_id"] ?>' onclick="add_wl(this)" type='submit'>
                                            <i class="fa fa-heart" aria-hidden="true"></i>
                                        </button> &nbsp;&nbsp;&nbsp;&nbsp;<span>|</span>&nbsp;&nbsp;&nbsp;&nbsp; <button class="product-fotter-button-css" value='<?php echo $row["prd_name"] ?>' id='<?php echo $row["prd_id"] ?>' onclick="add_cart(this)" type='submit'><i class="fa fa-shopping-bag" aria-hidden="true"></i></button></span></center>-->
                            </div>
                        </div>
                    </div>
<?php } ?>
        ...
        <script>function sort(str) {
                window.location = "Cake_Store.php?chk1=" + str;
            }</script>
        <script>
